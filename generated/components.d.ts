...
export interface ButtonsIcon extends Schema.Component {
  collectionName: 'components_buttons_icons';
  info: {
    displayName: 'icon';
    icon: 'cube';
    description: '';
...
export interface ButtonsSocialIcon extends Schema.Component {
  collectionName: 'components_buttons_social_icons';
  info: {
  ...
  attributes: {
    icons: Attribute.Component<'buttons.icon', true>;
  };
}
...
export interface ContentHorizontalCard extends Schema.Component {
  collectionName: 'components_content_horizontal_cards';
  info: {
    displayName: 'horizontal_card';
    icon: 'grid';
    description: '';
  };
  attributes: {
    title_card: Attribute.String;
    text_card: Attribute.Text;
    button_card: Attribute.Component<'buttons.button'>;
    image_card: Attribute.Media;
  };
}
...
export interface ImageMosaic extends Schema.Component {
  collectionName: 'components_image_mosaics';
  info: {
    displayName: 'mosaic';
    icon: 'dashboard';
  };
...
export interface ParagrapheNumberedList extends Schema.Component {
  collectionName: 'components_paragraphe_numbered_lists';
  info: {
    displayName: 'numbered_list';
    icon: 'bulletList';
  };
  attributes: {
...
export interface TextImageTextAndImage extends Schema.Component {
  ...
  attributes: {
    Image: Attribute.Media;
    Text_json: Attribute.Blocks;
    image_placement: Attribute.Enumeration<['Left', 'Right', 'Top', 'Bottom']> &
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'buttons.social-icon': ButtonsSocialIcon;
      ...
      'content.horizontal-card': ContentHorizontalCard;
      ...
      'paragraphe.numbered-list': ParagrapheNumberedList;
